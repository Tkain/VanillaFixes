...
This pack is currently built for the latest stable release of Minecraft: Java Edition, which is currently 1.19.3. Text fixes are only complete in English (EN-US), although translations are welcome.
